...
//
//Create a base class called Vehicle with the following methods: ● void
...
//method of the provided vehicle object
//and print "Vehicle serviced."
...
public class Main {
	...
	public static void main(String[] args) {
		...
		//instances of Car and Motorcycle. Create
		//an instance of the Garage class.
		Car car = new Car();
		...
		//Call the serviceVehicle() method of the Garage class with instances
		//of both Car and Motorcycle
		garage.serviceVehical(car);
		garage.serviceVehical(motorcycle);
